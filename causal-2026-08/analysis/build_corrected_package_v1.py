...
SEAL = os.environ.get("LIFESAT_SEAL", str(Path(__file__).resolve().parents[1] / "specs" / "seal" / "ACCEPTANCE_SEAL.json"))
...
PINS = {
    ...
    "scorer": "de16e29c73b7d2dcac87a114d755e130874eb892215be0947134afcf6f61a4cc",
